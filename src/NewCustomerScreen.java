...
public class NewCustomerScreen implements Initializable {
    ...
    public void AddCustomer(ActionEvent actionEvent) throws IOException, ClassNotFoundException {
        ...
        if(customerID.getText().matches("[0-9]*")){
            ...
            new Alert(Alert.AlertType.ERROR,"Wrong Type Entered in ID...").showAndWait();
            flag=0;
        }
        ...
        if(flag==1){
            ...
            new Alert(Alert.AlertType.INFORMATION,"Customer is Added in Record...").showAndWait();
